...
//		container.moveToFront(cheesePanel);
		...
		container.moveToFront(cheesePanel[i]);
                JLabel cheeselabel = new JLabel("#"+(i+1));
                cheeselabel.setForeground(Color.RED);
                cheeselabel.setBackground(Color.RED);
                cheeselabel.setBounds(getGridLeft(5), getGridTop(5), GRID_LENGTH, GRID_LENGTH);
                cheeselabel.setLocation(getGridLeft(newCheese[i].getX())+2, getGridTop(newCheese[i].getY()));
                cheeselabel.setOpaque(false);
